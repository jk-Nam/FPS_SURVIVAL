...
{
    protected StatusCtrl thePlayerStatus;
    ...
    [SerializeField] protected float waitTime; protected float currentTime;
    ...
    protected FOVAngle theViewAngle;

    // Start is called before the first frame update
    void Start()
    {
        thePlayerStatus = FindObjectOfType<StatusCtrl>();
        theViewAngle = GetComponent<FOVAngle>();
